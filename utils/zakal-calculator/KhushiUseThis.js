...
function getZakatInGrams(weightOfGold, weightOfSilver,price_NISABgold, price_NISABsilver)
{
    if (weightOfGold > price_NISABgold || weightOfSilver > price_NISABsilver)
    {
        return (weightOfGold+weightOfSilver) * ZAKAT_RATE;
    }
    return 0;
}

{
    ...
    const goldNisab = price_NISABgold * goldPrice;
    const silverNisab = price_NISABsilver * silverPrice;
